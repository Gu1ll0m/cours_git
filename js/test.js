    ...
    for (var i = 0; i < nombreCaseX; i++) {
        for (var j = 0; j < nombreCaseY; j++) {
            ...
            if (random == 1 && perso1_sur_la_map == false) { // si random est égal à 1 et que le perso1 n'est pas encore sur la map
                ...
                //$map.append('<div id=perso1 class=persoClass><img src='../img/perso1_alien.png' style='left:" + 100 * j + "px; top:" + 100 * i + "px'>"</div>');
...
function deplace() {
    ...
    $(document).keydown(function(e) { // la fonction se déclenche dès que l'utilisateur prèse une touche
        ...
        if (e.which == 38) { // Vers le haut
            $('#rapport1').html("<img src='../img/pad_haut.png' class='padClass' id='padHaut'>").fadeIn('slow').delay(100).fadeOut('slow');
        ...
        if (e.which == 39) { // Vers la droite
            $('#rapport1').html("<img src='../img/pad_droite.png' class='padClass' id='padDroite'>").fadeIn('slow').delay(100).fadeOut('slow');
        ...
        if (e.which == 40) { // Vers le bas
            $('#rapport1').html("<img src='../img/pad_bas.png' class='padClass' id='Bas'>").fadeIn('slow').delay(100).fadeOut('slow');
